				...
				<!--<li class="dropdown dropdown-item-slide">
						...
						<ul class="dropdown-menu dropdown-hover dropdown-persist pn w350 bg-white animated animated-shorter fadeIn" role="menu">
								...
								<li class="p10 br-t item-1">
										<div class="media">
												<a class="media-left" href="#"> <img src="html/assets/img/avatars/2.jpg" class="mw40" alt="holder-img"> </a>
								...
								<li class="p10 br-t item-2">
										<div class="media">
												<a class="media-left" href="#"> <img src="html/assets/img/avatars/3.jpg" class="mw40" alt="holder-img"> </a>
												<div class="media-body va-m">
														<h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
														<a class="text-system" href="#"> Max </a>
												</div>
								...
								<li class="p10 br-t item-3">
										<div class="media">
												<a class="media-left" href="#"> <img src="html/assets/img/avatars/4.jpg" class="mw40" alt="holder-img"> </a>
												<div class="media-body va-m">
														<h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
														<a class="text-system" href="#"> Max </a>
												</div>
								...
								<li class="p10 br-t item-4">
										<div class="media">
												<a class="media-left" href="#"> <img src="html/assets/img/avatars/5.jpg" class="mw40" alt="holder-img"> </a>
												<div class="media-body va-m">
														<h5 class="media-heading mv5">Article <small class="text-muted">- 08/16/22</small> </h5> Last Updated 36 days ago by
														<a class="text-system" href="#"> Max </a>
												</div>
