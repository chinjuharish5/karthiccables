...
<body class="external-page sb-l-c sb-r-c">
                    ...
                    <div class="row mb15 table-layout">
                        ...
                        <div class="col-xs-6 va-m pln">
                            <a href="dashboard.html" title="Return to Dashboard">
                                <img src="html/assets/img/logos/logo_white.png" title="AdminDesigns Logo" class="img-responsive w250">
                            </a>
                        </div>
                    ...
                    <div class="panel panel-info mt10 br-n">
                        ...
                        <div class="panel-heading heading-border bg-white">
							<div class="section row mn">
                                <div class="col-sm-12"><h2>Welcome to Karthic Cables</h2></div>
							</div>
    ...
    <!-- Page Plugins -->
    <!--<script type="text/javascript" src="html/assets/js/pages/login/EasePack.min.js"></script>
    <script type="text/javascript" src="html/assets/js/pages/login/rAF.js"></script>
    <script type="text/javascript" src="html/assets/js/pages/login/TweenLite.min.js"></script>
    <script type="text/javascript" src="html/assets/js/pages/login/login.js"></script>-->
