...
insert  into `company_list`(`company_id`,`company_name`,`branch`,`status`,`added_on`,`updated_on`) values (1,'karthickcabletv prorietor.k.myilvanan 04222251666 - 9489075500','kuniyamuthur','active','2018-03-03 00:40:27',NULL);
...
insert  into `tariff_list`(`tariff_id`,`tariff`,`amount`,`months`,`status`,`added_on`,`updated_on`) values (1,'210',210,1,'active','2018-03-03 00:40:27',NULL),(2,'150',150,1,'active','2018-03-03 00:40:27',NULL);
