...
--
-- Host: localhost:3306
-- Generation Time: Apr 07, 2018 at 10:45 PM
...
CREATE TABLE IF NOT EXISTS `sms_error_codes` (
...
CREATE TABLE IF NOT EXISTS `sms_track` (
...
CREATE TABLE IF NOT EXISTS `tariff_list` (
...
CREATE TABLE IF NOT EXISTS `user_import_dump` (
