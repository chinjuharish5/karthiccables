...
if(isset($_POST["submit"])) {
	...
	if($city_name!='' && $state_id!='' && $dist_id!='') {
		if(!empty($query_data) && $city_id!='') {
			$ins_data = $db->executeQuery("UPDATE city_list SET city='".$city_name."', state_id='".$state_id."', pincode='".$pincode."', dist_id='".$dist_id."' WHERE city_id='".$city_id."' ");
			//$city_id = $db->getLastInsertId();						
		} else {
			$ins_data = $db->executeQuery("INSERT INTO city_list (city, state_id, pincode, dist_id) VALUES ('".$city_name."', '".$state_id."', '".$pincode."', '".$dist_id."') ");
			$city_id = $db->getLastInsertId();			
		}
		...
		$error_msg = 'City Name cannot be empty !!!';
	}
}
                            ...
                            <div class="panel">
                                ...
                                <form method="post" id="admin-form">
                                    <div class="panel-body">
                                        ...
                                        <div class="section-divider mb40 mt20"><span> Add New City </span></div><!-- .section-divider -->
                                      ...
                                      <div class="section">
                                        ...
                                        <div class="section row">
                                            <div class="col-md-12">
                                                <label for="city_name" class="field prepend-icon">
                                                    <input type="text" name="city_name" id="city_name" class="gui-input" placeholder="Enter the city name..." value="<?php echo isset($query_data[0]['city']) ? strtoupper($query_data[0]['city']) : '';?>">
                                                    <label for="city_name" class="field-icon"><i class="fa fa-user"></i></label>  
                                                </label>
                                            </div><!-- end section -->
                                        ...
                                        <div class="section row">
                                            <div class="col-md-12">
                                                <label for="pincode" class="field prepend-icon">
                                                    <input type="text" name="pincode" id="pincode" class="gui-input" placeholder="Enter the Pincode..." value="<?php echo isset($query_data[0]['pincode']) ? strtoupper($query_data[0]['pincode']) : '';?>">
                                                    <label for="pincode" class="field-icon"><i class="fa fa-user"></i></label>  
                                                </label>
                                            </div><!-- end section -->
                                    ...
                                    <div class="panel-footer text-right">
                                        <button type="submit" name="submit" value="submit" class="button btn-primary"> Save City </button>
                                        <a href="city_listing.php"><button type="button" class="button"> Cancel </button></a>
